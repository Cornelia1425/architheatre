    ...
    return (
        <div  >
            <div className="main_inner" >
                <span>Welcome to ARCHITHEATRE, your window into the world of architecture through the eyes of an artist. Founded by Yiran, an avid traveler with a passion for creativity, ARCHITHEATRE invites you on a journey to explore the stories embedded within the built environment.<br/><br/>
...
<br/><br/>Welcome to ARCHITHEATRE, your window into the world of architecture through the eyes of an artist. Founded by Yiran, an avid traveler with a passion for creativity, ARCHITHEATRE invites you on a journey to explore the stories embedded within the built environment.<br/><br/>
